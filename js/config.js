...
const CONFIG = {
  ...
  assets: {
    ...
    sfxCardFlip:     'assets/audio/card-flip.mp3',
  },
  ...
  rules: {
    ...
    // Con 6 parejas en total: >3 aciertos = 4 o 5 o 6 => gana.
    //                          <=3 aciertos       => sigue intentando.
    winThreshold: 3,
    ...
    // Tiempo (ms) que se muestran las 12 cartas boca arriba al
    // empezar el tablero (para que el jugador memorice), antes de
    // voltearse todas boca abajo y habilitar el juego.
